...
- [`WP-0003`](work-packets/proposed/WP-0003.json): accepted lean A1 local Unity bootstrap for the project skeleton, deterministic seams, tests, and a non-gameplay technical interaction sandbox. It remains inactive until a distinct boundary receipt activates it.
