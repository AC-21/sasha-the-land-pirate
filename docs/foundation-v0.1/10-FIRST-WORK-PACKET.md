...
- [`WP-0003`](work-packets/proposed/WP-0003.json): proposed lean A1 local Unity bootstrap for the project skeleton, deterministic seams, tests, and a non-gameplay technical interaction sandbox. It is inactive until D-0052 is ratified, the packet is accepted, and a distinct boundary receipt activates it.
