...
namespace AtomicLandPirate.Presentation.LastBearing
{
    ...
    public sealed class LastBearingFieldDesk : MonoBehaviour
    {
        ...
        private void ApplyProjection(LastBearingFieldDeskProjection projection)
        {
            ...
            _bindings[2].Apply(projection.Survey.SelectA);
            _bindings[3].Apply(projection.Survey.SelectB);
            _bindings[4].Apply(projection.Survey.Manipulate);
            _bindings[5].Apply(projection.Survey.Rotate);
            _bindings[6].Apply(projection.Survey.TogglePiece);
            _bindings[7].Apply(projection.Survey.Connect);
            _bindings[8].Apply(projection.Survey.Advance);
            _bindings[9].Apply(projection.Survey.RecordClear);
            _bindings[10].Apply(projection.Survey.RecordUnclear);
            _bindings[11].Apply(projection.Survey.Reset);
            _bindings[12].Apply(projection.Survey.Leave);
            _bindings[13].Apply(projection.Survey.Clear);
        ...
        private void Dispatch(ButtonBinding source)
        {
            ...
            switch (source.Intent)
            {
                ...
                case LastBearingFieldDeskIntent.SelectTrialA: _controller.SelectCityGrammarHypothesis(LastBearingCityGrammarHypothesis.RestrainedSnapGrid); break;
                case LastBearingFieldDeskIntent.SelectTrialB: _controller.SelectCityGrammarHypothesis(LastBearingCityGrammarHypothesis.DistrictStamp); break;
                case LastBearingFieldDeskIntent.ManipulateTrial: _controller.ManipulateCityGrammarPrimary(); break;
                case LastBearingFieldDeskIntent.RotateTrial: _controller.RotateCityGrammarPrimary(); break;
                case LastBearingFieldDeskIntent.ToggleTrialPiece: _controller.ToggleCityGrammarTrialPiece(); break;
                case LastBearingFieldDeskIntent.ConnectTrial: _controller.ConnectCityGrammarLogistics(); break;
                case LastBearingFieldDeskIntent.AdvanceTrialDelivery: _controller.AdvanceCityGrammarDelivery(); break;
                case LastBearingFieldDeskIntent.RecordPathClear: _controller.RecordCityGrammarPathRead(true); break;
                case LastBearingFieldDeskIntent.RecordPathUnclear: _controller.RecordCityGrammarPathRead(false); break;
                case LastBearingFieldDeskIntent.ResetActiveTrial: _controller.ResetActiveCityGrammarTrial(); break;
                case LastBearingFieldDeskIntent.LeaveTrial: _controller.LeaveCityGrammarComparison(); break;
                case LastBearingFieldDeskIntent.ClearTrials: _controller.ResetCityGrammarComparison(); break;
                case LastBearingFieldDeskIntent.ActivateInfrastructure: _controller.ActivateInfrastructure(); break;
