...
- Sealed receipts `RR-D0049-20260715` and `RR-WP0001-ACCEPT-20260715` remain immutable history. Unsealed creator receipt `RR-D0051-20260716` records the direct-MCP successor without changing WP-0001 contract `eed333603affe6aa1dd2b16b26ae702d9f561cc653fa319da02abfe008faeda3`; it does not replace the packet's required protected route-amendment receipt. WP-0001 may enter A1 only after a creator-controlled external `packet-acceptance` receipt binds `UNITY-MCP-EXTERNAL` to that exact contract, the assigned Unity seat and linked organization/project, exact relay/client/project target and approved connection, exact D-0047 installation, and standalone physical quarantine are verified, and a separate activation receipt binds them.
